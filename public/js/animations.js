...
window.onload = function () {
	var toggleButton = document.getElementById('bars-menu-web');
	var menu = document.querySelector('.header-top__right');
	...
	goUp.addEventListener('click', function (e) {
		...
		var interval = window.setInterval(function () {
			if (window.scrollY !== 0) window.scrollBy(0, scrollStep);else window.clearInterval(interval);
		}, 15);
	});
